...
import 'package:arrant_construction_client/src/widgets/custom_circular_progress_indicator.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class Helper {
  late BuildContext context;
  static List<VendorService> _vendorServices = [];
  ...
  static setVendorServices(List<VendorService> services) {
    _vendorServices = services;
  }

  static List<VendorService> getVendorServices() {
    return _vendorServices;
  }

  static String getUserAuthToken() {
    return user_repo.currentUser.authToken.isNotEmpty
        ? user_repo.currentUser.authToken
        : '';
  }
